...
* @since 1.0
*/
class Tablejtask_detail extends JTable
{
	/**
	 * Primary Key
	 *
	 ...
	 * @since 1.0
	 */
	function Tablejtask_detail(& $db) 
	{
		//initialize class property
	  $this->_table_prefix = '#__djfacl_';
			
		parent::__construct($this->_table_prefix.'jtask', 'id', $db);
	}
	...
	*/
	...
	function check()
	{
		...
		$query = 'SELECT id FROM '.$this->_table_prefix.'jtask  WHERE id = '.$this->id;
