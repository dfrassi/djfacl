...
* @since 1.0
*/
class Tableicon_detail extends JTable
{
	/**
	 * Primary Key
	 *
  ...
  var $checked_out_time= 0;
	 ...
	 * @since 1.0
	 */
	function Tableicon_detail(& $db) 
	{
		//initialize class property
	  $this->_table_prefix = '#__djfacl_';
			
		parent::__construct($this->_table_prefix.'quickicon', 'id', $db);
	}
	...
	*/
	...
	function check()
	{
		...
		$query = 'SELECT id FROM '.$this->_table_prefix.'quickicon  WHERE id = '.$this->id;
