...
var form = document.adminForm;
   if (pressbutton)
    {form.task.value=pressbutton;}
	 ...
	 {
	  form.controller.value="cssblock_detail";
	 }
	try {
		form.onsubmit();
		}
...
<table>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		$row = &$this->items[$i];
		$row->checked_out="";
		$link 	= JRoute::_( 'index.php?option=com_djfacl&controller=cssblock_detail&task=edit&cid[]='. $row->id );
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
					...
					<a <?php echo $script_ceccato; ?> href="<?php echo $link; ?>" title="<?php echo JText::_( 'Edit cssblock' ); ?>">
						<?php echo $row->id; ?></a>
...
<div>
<p><b>Note:</b> <?php echo(JText::_ ( 'CSSBLOCK_DESCRIZIONE' )); ?></p>
</div>


<input type="hidden" name="controller" value="cssblock" />
