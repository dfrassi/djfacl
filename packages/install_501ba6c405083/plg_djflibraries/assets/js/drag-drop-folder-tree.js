...
************************************************************************************************************/	
	...
	/* Constructor */
	function JSDragDropTree(imageFolder)
	{
		var idOfTree;
		var imageFolder;
		var folderImage;
		...
		initTree : function()
		{
			...
			if(this.deleteAllowed || this.renameAllowed){
				try{
					...
					var menuModel = new DHTMLGoodies_menuModel(imageFolder);
					...
					var menuModelRenameOnly = new DHTMLGoodies_menuModel(imageFolder);
					if(this.renameAllowed)menuModelRenameOnly.addItem(3,'Rename','','',false,'JSTreeObj.renameItem');
					menuModelRenameOnly.init();	
					
					var menuModelDeleteOnly = new DHTMLGoodies_menuModel(imageFolder);
					...
					this.contextMenu = new DHTMLGoodies_contextMenu(imageFolder);
